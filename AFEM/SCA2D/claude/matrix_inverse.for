...
C Related Links: http://www.mpi-hd.mpg.de/astrophysik/HEA/internal/Numerical_Recipes/f2-3.pdf
C Description: 'a' goes in, y=inverse(a) goes out
...
C Related Links: http://www.mpi-hd.mpg.de/astrophysik/HEA/internal/Numerical_Recipes/f2-3.pdf
C Description: 'a' goes in, y=inverse(a) goes out; same as 'matrixInverse' but with quad precision
...
C Description: solves Ax=b via LU-decomposition with double precision
      !input: A,b
      !output: x in place of b
      !successful: flag=1, not succesful: flag=0
