...
C     STANDARD VARIABLES
      ...
      REAL*8::stepTIME,totalTIME,DT,L,Leff
      REAL*8::PROPS, SIG(6)
...
C       (3) Ecr_MAX    - stores the max local crack strain
C       (5) Ecr_OLD    - stores the prev increment local crack strain
...
C       ZONE      = STATEV(4)  ! Allot zone in Traction-Separation Law
...
C-----------------------------------------------------------------------   
      ...
      real*8::Ecr_OLD(3),Ecr_MAX(3),GIc,sigcr0,Leff,Dcr(3,3),nu
